...
def get_recommendations(content, ranking, url, main_keyword, image_alts, engine='gpt-4', purpose='general'):
    ...
    prompt = f"Analyze the provided content, headings, meta description, and alt tags for the website {url} with SEO in mind. "\
             ...
             "Detailed and actionable recommendations for improving SEO ranking for '{main_keyword}'. [this section should provide specific examples, whether that means pointing out specific places in the copy to insert keywords, or provide examples of rewritten header. Assume the reader isn't knowledgeable and provide a detailed explanation that shys away from simply giving jargon and demonstrates exactly what to change and adjust with direct examples using the actual copy from the website content provided. this section should be no shorter than 300 words]\n"\
