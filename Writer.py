...
# Initialize a variable to track if the blog content has been generated
...
def generate_structured_blog(topic, length, url="", include_cta=False, cta_text=""):
    ...
    """
    global content_generated  # Access the global variable to update it
    messages = [
    ...
    try:
        ...
        content_generated = True  # Update the variable to indicate content generation
        return blog_content
    except Exception as e:
        content_generated = False  # Ensure variable reflects failure to generate content
...
# Conditionally render the tools, buttons, and bottom image
if content_generated:  # This block will only execute if blog content has been successfully generated
    st.markdown("---")
