...
st.markdown("[Use Now - Competitive Edge](https://seotool-mfvdnqmf32f3visjegsxho.streamlit.app)", unsafe_allow_html=True)
...
st.markdown("[Use Now - Blog SEO Helper](https://seotool-7uqzcambnfjnuuwh9pctlr.streamlit.app)", unsafe_allow_html=True)
...
st.markdown("[Use Now - RepuSEO Plagiarism Checker](https://seotool-cdjzyqj4qrskqvkuahwjwm.streamlit.app)", unsafe_allow_html=True)
...
st.markdown("[Use Now - RepuSEO-Helper](https://seotool-qpb8fq8bygcusdsxn6pm6s.streamlit.app)", unsafe_allow_html=True)