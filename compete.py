...
def scrape_competitor_data(url):
    ...
    return content, meta_description, meta_keywords
...
def generate_recommendations(competitor_data):
    ...
    prompt = f"Generate new meta and main copy blurbs based on the following content: {all_content}, meta descriptions: {all_meta_descriptions}, and meta keywords: {all_meta_keywords}."
    try:
